(function() {
  var CHROME_VERSIONS_WITH_BUGGY_ROOT_LAYER_SCROLLING, LOAD_EXTENSION, Promise, _, _normalizeArgExtensions, appData, debug, defaultArgs, extension, fs, os, pathToExtension, pathToTheme, plugins, utils,
