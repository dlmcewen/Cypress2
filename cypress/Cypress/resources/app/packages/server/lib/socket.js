(function() {
  var Promise, Socket, _, automation, cwd, errors, exec, files, fixture, fs, isSpecialSpec, log, logger, open, path, pathHelpers, preprocessor, reporterEvents, retry, runnerEvents, socketIo, task, uuid,
    slice = [].slice;
