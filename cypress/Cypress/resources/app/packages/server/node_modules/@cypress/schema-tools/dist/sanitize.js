...
var isJsonSchema = function (o) {
    return isString(o.title) && o.properties && o.type === 'object';
};
var hasPropertiesArray = function (prop) {
    return isArrayType(prop) && prop.items && isJsonSchema(prop.items);
};
exports.sanitizeBySchema = function (schema, formatDefaults) { return function (object) {
    var isDynamic = exports.isDynamicFormat(formatDefaults);
        ...
        Object.keys(props).forEach(function (key) {
            ...
            if (key in object && Array.isArray(object[key])) {
                ...
                if (isStringArray(prop)) {
                    ...
                    result[key] = list.map(exports.sanitizeBySchema(propSchema, formatDefaults));
                    return;
                }
            }
...
exports.sanitize = function (schemas, formatDefaults) { return function (name, version) { return function (object) {
    ...
    return exports.sanitizeBySchema(schema.schema, formatDefaults)(object);
}; }; };
